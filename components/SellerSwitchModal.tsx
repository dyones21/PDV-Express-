...
export function SellerSwitchModal({ onClose }: SellerSwitchModalProps) {
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl border border-amber-100 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="bg-amber-700 px-5 py-4 text-white flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold">Identificação do Vendedor</h2>
          </div>
          <button
            ...
            <>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-neutral-500 capitalize">
                            {s.role === 'owner' ? 'Dono / Titular' : 'Ajudante / Vendedor'}
                          </div>
                        </div>
                      </div>
              ...
              {selectedSeller && (
                <div className="mt-4 pt-3 border-t border-neutral-100">
                  ...
                  {/* PIN Display Bubbles */}
                  <div className="flex justify-center items-center gap-3 py-2 mb-3 bg-neutral-50 rounded-xl border border-neutral-200">
                    {[0, 1, 2, 3].map((idx) => (
                      <div
                        key={idx}
              ...
              <div className="mt-4 space-y-2">
                <button
                  ...
                  onClick={handleLogin}
                  className="w-full py-3 px-4 bg-amber-700 hover:bg-amber-800 text-white font-bold rounded-xl shadow-md disabled:opacity-50 transition active:scale-[0.98]"
                >
